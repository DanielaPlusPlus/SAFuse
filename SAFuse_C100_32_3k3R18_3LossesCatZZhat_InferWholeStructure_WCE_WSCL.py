...
from networks.A1005_ResNet_cifar_CCAMix_model2_lessChannel_CatZZhat_InferWithWholeStructure import resnet50, resnet18
...
def make_print_to_file(path='./'):
    ...
    sys.stdout = Logger(
        fileName + 'A1008_C100_32_3k3R18_CCAMix_3LossesCatZZhat_InferWholeStructure_WCE_WSCL.log', path=path)
...
parser.add_argument("--START_EPOCH", type=int, default=550)
...
name = './Models_out/A1008_C100_32_3k3R18_CCAMix_3LossesCatZZhat_InferWholeStructure_WCE_WSCL_best.pt'
if len(args.gpu_ids) > 1:
    if args.RESUME:
        net = resnet18(pretrained=False)
        net.fc2 = nn.Linear(576, args.NUM_CLASS)
...
results_file_name = results_out_dir + tm + 'A1008_C100_32_3k3R18_CCAMix_3LossesCatZZhat_InferWholeStructure_WCE_WSCL_results.txt'
...
for epoch in range(args.START_EPOCH, args.NB_EPOCH):
    ...
    for batch in tqdm(trainloader):
        ...
        if args.p_binom > 0 and r < args.cutmix_prob:
            ...
            """fea, label, weight, find the begining, sp=0"""
            loss_local_ce = 0
            ...
            """fea, label, weight, main part, sp>0"""
