...
from networks.A1009_ResNeXt_CUB224_CCAMix_lessChannel_CatZZhat_InferWholeStructure import resnext50
...
def make_print_to_file(path='./'):
    ...
    sys.stdout = Logger(
        fileName + 'A1009_CUB224_RX50_CCAMix_3LossesCatZZhat_InferWholeStructure_WCE_WSCL.log', path=path)
...
parser = argparse.ArgumentParser(
    description="CCAMix_self_C100_32_3k3RX50")
...
name = './Models_out/A1009_CUB224_RX50_CCAMix_3LossesCatZZhat_InferWholeStructure_WCE_WSCL_best.pt'
if len(args.gpu_ids) > 1:
    if args.RESUME:
        net = resnext50(pretrained=True)
...
results_file_name = results_out_dir + tm + 'A1009_CUB224_RX50_CCAMix_3LossesCatZZhat_InferWholeStructure_WCE_WSCL_results.txt'
